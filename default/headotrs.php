...
<body style="background: #fff;">
    ...
    <div style="margin-top: 31px;margin-left: 100px;margin-right: 53px;" class="container-fluid-full">
        <div class="row-fluid">      
            ';
    include $_SERVER['DOCUMENT_ROOT'].'/intranet/alarma/default/menuotrs.php';
