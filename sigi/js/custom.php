...
function charts() {
	...
	{	
		...
		$sql7="select fecha, COUNT(*) as Total FROM ticke GROUP BY fecha HAVING COUNT(*) > 1 limit 30";
		echo "[";
		$rs7=mysqli_query($enlace, $sql7);
		$i=1;
		if(mysqli_num_rows($rs7)<1){		                                   
		}else{		                                
	...
	{	
		var likes = [[1, 5+randNumFB()], [2, 10+randNumFB()], [3, 15+randNumFB()], [4, 20+randNumFB()],
