		            ...
		            <div id="content" class="span10">
		                <ul class="breadcrumb">
		                   ...
		                   <li>
		                        ...
		                        <a href="/eweb2019/sigi/tickets/">Gestionar Tickets</a>
		                        <i class="icon-angle-right"></i>
		                    </li>
		                    <li>
		                   		<i class="icon-edit"></i>
							                    ...
							                    <div class="bg_velo">				                                                
								                    <div class="cont-msj">
									                    ...
									                    <div class="alert alert-success aleta-exit">
															...
															<br />
															<a href="/eweb2019/sigi/tickets/" name="enviar" class="btn btn-success btn-acep">
																Aceptar
															</a>
														</div>
													</div>
				                        ...
				                        echo '
							                    <div class="bg_velo">				                                                
									                    <div class="cont-msj">
										                    ...
										                    <div class="alert-danger aleta-exit" style="background-color: #fdeaea !important;color: #ca6f74 !important;border: 1px solid #f27b81 !important;padding-top: 20px;height: 100px;">
																<strong>El ticket todavia se encuentra abierto debe estar <br>cerrardo o estar en estatus procesado</strong>
																<br />
