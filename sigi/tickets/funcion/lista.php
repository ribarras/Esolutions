	                            ...
	                            <div class="box-content">
	                                <table class="table table-striped table-bordered bootstrap-datatable datatable">
	                                    ...
	                                    ';
	         							...
	         							$sql1="select id, asun, dep, prio, fcreacion, est from ticke where est='Abierto' or est='En Proceso' ORDER by id ASC";
									      ...
									      if(mysqli_num_rows($rs1)<1){
									       ...
									       while ($row1 = mysqli_fetch_array($rs1)){
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td style="text-align: center;">
	                                                <a class="btn btn-primary" href="/eweb2019/sigi/tickets/editar/?id=';echo base64_encode($row1["id"]);echo '&';echo base64_encode($row1["fcreacion"]);echo '&';echo base64_encode($row1["est"]);echo '&';echo base64_encode($row1["prio"]);echo'">
